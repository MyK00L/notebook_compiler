...
struct Config {
	layout: PaperType,
	landscape: bool,
	lmargin: u16, // left margin in mm
	rmargin: u16, // right margin in mm
	tmargin: u16, // top margin in mm
	bmargin: u16, // bottom marin in mm
	title: String,
	author: String,
	...
	tabsize: u8,
	linenos: bool,
	numbersep: u8,         // numbers distance in mm
	...
	framestep: u16,    // distance between frame and content in mm
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
	...
	writeln!(tex,"\\usepackage[paper={},lmargin={}mm,rmargin={}mm,tmargin={}mm,bmargin={}mm,landscape={}]{{geometry}}",config.layout.to_string(),config.lmargin,config.rmargin,config.tmargin,config.bmargin,config.landscape)?;
	...
	for i in extensions.iter() {
		writeln!(tex,"\\newminted{{{}}}{{tabsize={},linenos={},mathescape={},autogobble={},showspaces={},showtabs={},breaklines={},breakanywhere={},breakautoindent={},fontfamily={},frame={},framerule={},style={},numbersep={}mm}}",i.1,config.tabsize,config.linenos,config.mathescape,config.autogobble,config.showspaces,config.showtabs,config.breaklines,config.breakanywhere,config.breakautoindent,config.fontfamily,config.frame.to_string(),config.framerule,config.style,config.numbersep)?;
	}
