...
fn main() -> Result<(), Box<dyn std::error::Error>> {
	...
	writeln!(tex,"\\usepackage[paper={},lmargin={},rmargin={},tmargin={},bmargin={},foot=0pt,landscape={}]{{geometry}}",config.layout.to_string(),config.lmargin,config.rmargin,config.tmargin,config.bmargin,config.landscape)?;
